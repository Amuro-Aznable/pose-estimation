...
filename = 'datasets/NTU/nturgb+d_npy/126.npy'
...
for i in range(n_body):
    ...
    for key, fathers in hierarchy.items():
        ...
        father = fathers[0]
        ax.plot3D([
            first_frame[keypoints_to_index[father] - 1][0],
            first_frame[keypoints_to_index[key] - 1][0]
        ], [
            first_frame[keypoints_to_index[father] - 1][1],
            first_frame[keypoints_to_index[key] - 1][1]
        ], [
            first_frame[keypoints_to_index[father] - 1][2],
            first_frame[keypoints_to_index[key] - 1][2]
        ], 'gray')
